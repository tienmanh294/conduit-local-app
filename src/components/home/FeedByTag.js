...
import { useGetArticleByTagQuery } from '../../api/articleApiSlice';
import ArticleItem from '../article/ArticleItem';

const FeedByTag = props => {
  ...
  const {
    ...
    isError,
    error,
  } = useGetArticleByTagQuery({ tag: props.tag, limit: articlesPerPage, skip: currentPage });
